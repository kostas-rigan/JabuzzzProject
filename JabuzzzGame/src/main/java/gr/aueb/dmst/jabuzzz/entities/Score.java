...
/**
 * Class Score changes the team score and checks if the top or bottom target has been reached.
...
public class Score {
	...
	/*
	 * correctAnswer is called when a team has given a correct answer and increases the teams score by one.
	 */
	...
	/*
	 * wrongAnswer is called when a team has given a wrong answer and decreases the teams score by one.
	 */
